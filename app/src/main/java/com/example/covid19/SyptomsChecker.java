...
public class SyptomsChecker extends AppCompatActivity {
   ...
   // int ar[]=new int[2];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syptoms_checker);
     ...
     //  percent=(int)count*100;
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                note.setText("*This is based on current undrtstanding of the disease which is subject to change. Please do consult the Doctor and take advice in case you are not feeling well");
